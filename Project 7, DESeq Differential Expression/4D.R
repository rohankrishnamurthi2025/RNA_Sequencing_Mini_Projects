...
# Rohan Krishnamurthi
# 11/24/2024
# 2 good samples of each, WT_21, SNF2_06
...
yeast_count_table_replacements_filtered <- yeast_count_table_replacements |> 
  select(SNF2_06, SNF2_15, SNF2_31, WT_21, WT_18, WT_20)


# first get vector of column names
samplename_2 <- colnames(yeast_count_table_replacements_filtered)
...
DDS_yeast_2 <- DESeqDataSetFromMatrix(countData = yeast_count_table_replacements_filtered,
